document.addEventListener("DOMContentLoaded", async function() {
    ...
    const contractAddress = '0x154C1D31ba23698C3C187B376974e2F13647FBe1'
    const contractABI = [
        {
            "inputs": [
                {
    ...
    document.getElementById('createNFTForm').addEventListener('submit', async function(event) {
        ...
        await nftContract.methods.createNFT(tokenId, price).send({ from: fromAddress });
    ...
    document.getElementById('getNFTForm').addEventListener('submit', async function(event) {
        ...
        document.getElementById('result').innerHTML = `Dono: ${result[0]}, Preço: ${result[1]}, Á venda: ${result[2]}`
    })
})